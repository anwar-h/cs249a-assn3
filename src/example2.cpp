...
int main(int argc, char *argv[]) {
    ...
    if (customer1 == nullInstance || customer2 == nullInstance || port1 == nullInstance) {
    ...
    if (boatSeg1 == nullInstance || boatSeg2 == nullInstance || truckSeg1 == nullInstance || truckSeg2 == nullInstance) {
