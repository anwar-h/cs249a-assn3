...
TEST(A2Test, testLocationAttributes) {
    ...
    EXPECT_EQ(seg1->attribute("length"), "10.50");
    ...
    EXPECT_EQ(seg2->attribute("source"), "loc2");
    EXPECT_EQ(seg2->attribute("length"), "3.00");
    EXPECT_EQ(seg2->attribute("return segment"), "seg1"); 
    EXPECT_EQ(seg2->attribute("difficulty"), "5.00");
    EXPECT_EQ(seg2->attribute("expedite support"), "yes");
...
TEST(A2Test, testSegmentAttributes) {
    ...
    EXPECT_EQ(loc->attribute("segment1"), "seg1");
    EXPECT_EQ(loc->attribute("segment2"), "seg2");
    EXPECT_EQ(loc->attribute("segment3"), "seg3");
...
TEST(A2Test, testStatsAttributes) {
    ...
    EXPECT_EQ(stats->attribute("Plane segment"), "2");
    EXPECT_EQ(stats->attribute("Truck segment"), "5");
    EXPECT_EQ(stats->attribute("Customer"), "1");
    EXPECT_EQ(stats->attribute("Port"), "1");
    EXPECT_EQ(stats->attribute("Truck terminal"), "4");
...
TEST(A2Test, testStatsAttributes2){
    ...
    m->instanceDel("loc8");
    EXPECT_EQ(stats->attribute("Truck terminal"), "3");

    Ptr<Instance> seg1 = m->instance("seg1");
    seg1->attributeIs("expedite support", "yes");
    EXPECT_EQ(stats->attribute("expedite percentage"), "12.50");
    ...
    m->instanceDel("seg7");
    m->instanceDel("seg8");
    EXPECT_EQ(stats->attribute("expedite percentage"), "25.00");
...
TEST(A2Test, testFleetAttributes) {
    ...
    EXPECT_EQ(fleet->attribute("Boat, speed"), "1.00");
    EXPECT_EQ(fleet->attribute("Boat, cost"), "2.00");
    EXPECT_EQ(fleet->attribute("Boat, capacity"), "3");

    EXPECT_EQ(fleet->attribute("Plane, speed"), "4.00");
    EXPECT_EQ(fleet->attribute("Plane, cost"), "5.00");
    EXPECT_EQ(fleet->attribute("Plane, capacity"), "6");

    EXPECT_EQ(fleet->attribute("Truck, speed"), "7.00");
    EXPECT_EQ(fleet->attribute("Truck, cost"), "8.00");
...
TEST(A2Test, testSegmentSourceChange) {
    ...
    EXPECT_EQ(loc1->attribute("segment2"), "seg3");
    MAYBETHROW(EXPECT_EQ(loc1->attribute("segment3"), ""));
